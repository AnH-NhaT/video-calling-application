...
// setup connect by ip port socket
...
// setup connect by ip and account login
...
//file sound call
				...
				e.printStackTrace();
				JOptionPane.showMessageDialog(null, "Please check your connect or try later!", "Disconnect with server", 0);
			}
		});
	}
}
